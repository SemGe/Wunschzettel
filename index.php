<?php
/**
Description: Einsendeaufgabe 3: PHP-Wunschzettel
@author Georgios Semertzidis
*/
    session_start();
            ...
            if (empty($_POST["choice1"]) && empty($_POST["choice2"]) && empty($_POST["choice3"])) {
                ...
                if(!empty($_POST["choice1"])){
                    if (!preg_match("/^[a-zA-Z ]*$/",$_POST["choice1"]))
                        $choice1_error = "Keine Sonderzeichen erlaubt"; 
                    else
                ...
                if(!empty($_POST["choice2"])){
                    if (!preg_match("/^[a-zA-Z ]*$/",$_POST["choice2"]))
                        $choice2_error = "Keine Sonderzeichen erlaubt."; 
                    else
                ...
                if(!empty($_POST["choice3"])){
                    if (!preg_match("/^[a-zA-Z ]*$/",$_POST["choice3"])) 
                        $choice3_error = "Keine Sonderzeichen erlaubt."; 
                    else
            ...
            if (empty($_POST["first_last_name"]) && empty($_POST["zip"]) && empty($_POST["phone"])) {
                ...
                if(!empty($_POST["first_last_name"])){
                    if (!preg_match("/^[a-zA-Z ]*$/",$_POST["first_last_name"]))
                        $name_error = "Keine Sonderzeichen erlaubt."; 
                    else
...
<form method="post" action="">
    ...
    <table>
        <tr>
            <td>
                <label class="<?php if(!empty($choice1_error)) echo 'error'; ?>">1. Wunsch</label>
            </td>
            <td>
        ...
        <tr>
            <td>
                <label class="<?php if(!empty($choice2_error)) echo 'error'; ?>">2. Wunsch</label>
            </td>
            <td>
        ...
        <tr>
            <td>
                <label class="<?php if(!empty($choice3_error)) echo 'error'; ?>">3. Wunsch</label>
            </td>
            <td>
